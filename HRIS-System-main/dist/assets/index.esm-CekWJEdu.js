import{r as y,e as T,C as b,c as S,E as G,F as H,B as me,L as we,o as K,g as Ie,m as ye,q as Te,G as N,H as be,I as Ae,J as ve}from"./index-eirGwIZx.js";const W="@firebase/installations",D="0.6.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $t{constructor(t){this.app=t}_delete(){return delete I[this.app.options.appId],Promise.resolve()}}let I={},L=[];const j={};let P="dataLayer",Nt="gtag",B,he,V=!1;function xt(){const e=[];if(Te()&&e.push("This is a browser extension environment."),ve()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function qt(e,t,n){xt();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(I[a]!=null)throw d.create("already-exists",{id:a});if(!V){wt(P);const{wrappedGtag:s,gtagCore:r}=bt(I,L,j,P,Nt);he=s,B=r,V=!0}return I[a]=Ot(e,L,j,t,B,P,n),new $t(e)}function Ut(e=Ie()){e=K(e);const t=S(e,v);return t.isInitialized()?t.getImmediate():Lt(e)}function Lt(e,t={}){const n=S(e,v);if(n.isInitialized()){const i=n.getImmediate();if(ye(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}function jt(e,t,n,a){e=K(e),Ft(he,I[e.app.options.appId],t,n,a).catch(i=>u.error(i))}const U="@firebase/analytics",z="0.10.18";function Bt(){T(new b(v,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return qt(a,i,n)},"PUBLIC")),T(new b("analytics-internal",e,"PRIVATE")),y(U,z),y(U,z,"esm2020");function e(t){try{const n=t.getProvider(v).getImmediate();return{logEvent:(a,i,s)=>jt(n,a,i,s)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Bt();export{Ut as getAnalytics,Lt as initializeAnalytics,jt as logEvent};
