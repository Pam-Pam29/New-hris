...
import { getAuth, confirmPasswordReset as firebaseConfirmPasswordReset } from 'firebase/auth';
                ...
                <CardContent>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <button
                                onClick={() => navigate('/hr-onboarding-signin')}
