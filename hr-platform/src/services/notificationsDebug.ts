...
export async function debugNotificationsCollection() {
    try {
        ...
        const docRef = await addDoc(collection(getFirebaseDb(), 'notifications'), testNotification);
        ...
        const newNotificationsQuery = query(collection(getFirebaseDb(), 'notifications'), limit(5));
...
export async function createSimpleNotification() {
    try {
        ...
        const docRef = await addDoc(collection(getFirebaseDb(), 'notifications'), notification);
