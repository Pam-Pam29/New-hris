    ...
    const handleInputChange = (field: string, value: any, section?: string) => {
        if (section) {
            setFormData(prev => ({
                ...prev,
                [section]: {
                    ...prev[section as keyof EmployeeProfileData],
                    [field]: value
                }
            }));
        } else {
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input
                                id="nationalId"
                                value={currentData.personalInfo?.nationalId || ''}
                                onChange={(e) => handleInputChange('nationalId', e.target.value, 'personalInfo')}
                                disabled={!editing}
                            />
                        </div>
                    </CardContent>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <Input
                                    id="postalCode"
                                    value={currentData.contactInfo?.address?.postalCode || ''}
                                    onChange={(e) => handleInputChange('postalCode', e.target.value, 'contactInfo.address')}
                                    disabled={!editing}
                                />
                            </div>
                        </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            <Input
                                id="employeeId"
                                value={currentData.workInfo?.employeeId || ''}
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input
                                id="emergencyName"
                                value={currentData.contactInfo?.emergencyContact?.name || ''}
                                onChange={(e) => handleInputChange('name', e.target.value, 'contactInfo.emergencyContact')}
                                disabled={!editing}
                            />
                        </div>
                        <div>
                            ...
                            <Input
                                id="emergencyPhone"
                                type="tel"
                                value={currentData.contactInfo?.emergencyContact?.phone || ''}
                                onChange={(e) => handleInputChange('phone', e.target.value, 'contactInfo.emergencyContact')}
                                disabled={!editing}
                            />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            value={currentData.contactInfo?.emergencyContact?.relationship || ''}
                            onChange={(e) => handleInputChange('relationship', e.target.value, 'contactInfo.emergencyContact')}
                            disabled={!editing}
                        />
                    </div>
                </CardContent>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="text-center">
                                <div className="text-2xl font-bold text-green-600">
                                    {profile.lastUpdated ?
                                        Math.floor((new Date().getTime() - new Date(profile.lastUpdated).getTime()) / (1000 * 60 * 60 * 24)) : 0}
                                </div>
